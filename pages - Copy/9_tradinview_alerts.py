...
alerts["Growth Score"] = alerts["symbol"].map(
    score_lookup["Growth Score"]
)

alerts["Cashflow Score"] = alerts["symbol"].map(
    score_lookup["Cashflow Score"]
)

alerts["Composite Score"] = alerts["symbol"].map(
    score_lookup["Composite Score"]
)

alerts["Grade"] = alerts["symbol"].map(
    score_lookup["Grade"]
)
